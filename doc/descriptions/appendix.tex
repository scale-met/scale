...
\chapter{4th order advection scheme}
{
\footnotesize
The 4th order scheme of advection with the constant velocity:
\begin{eqnarray}
&&   \frac{\partial \phi}{\partial t}
 + c \frac{-\phi_{i+2}+8\phi_{i+1}-8\phi_{i-1}+\phi_{i+2}}{12\Delta x} = 0
\end{eqnarray}
where
\begin{eqnarray}
&& \phi_{i+2} = \phi_{i}
...
&&
\frac{-\phi_{i+2}+7\phi_{i+1}+\phi_{i+1}-7\phi_{i-1}-\phi_{i-1}+\phi_{i+2}}{12\Delta x}
= \left(\frac{\partial \phi}{\partial x}\right)_{i}+ O(\Delta x^4)
\end{eqnarray}
