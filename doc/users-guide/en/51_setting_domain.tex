...
If the value \verb|REAL| is specified in \nmitem{ATMOS_BOUNDARY_TYPE} in \namelist{PARAM_ATMOS_BOUNDARY}, no nudging is applied in upper boundary by default.
