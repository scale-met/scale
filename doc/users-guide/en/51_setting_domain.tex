...
&&\quad = \left(\nmitemeq{IMAX} \times \nmitemeq{PRC_NUM_X}\right)
          ...
          \times (\nmitemeq{KMAX} ).
\end{eqnarray}
\nmitem{IMAX} and \nmitem{JMAX} are internally calculated when \nmitem{IMAXG} and \nmitem{JMAXG} are specified.
...
\verb| IMAXG = 40,|  & ; number of grids along the {\XDIR} \\
\verb| JMAXG = 25,|  & ; number of grids along the {\YDIR} \\
\verb|/|\\
}
