...
\editboxtwo{
  ...
  ~~\verb|                  = 'lerp_initpoint',| & ; Temporal interpolation type. \\
                                                 ...
                                                 &  ~\verb|lerp_midpoint|: same as \verb|lerp_initpoint| but the values are temporal average during the time step. \\
...
\nmitem{ATMOS_BOUNDARY_USE_POTT}, and \nmitem{ATMOS_BOUNDARY_USE_QV} are used only for the top boundary in this case.
