...
If \nmitem{ATMOS_BOUNDARY_TYPE} in \namelist{PARAM_ATMOS_BOUNDARY} is \verb|REAL|, the nudging at the lateral boundary for the horizontal velocities, potential temperature, and vapor is forced to be applied.
The switches of \nmitem{ATMOS_BOUNDARY_USE_VELX}, \nmitem{ATMOS_BOUNDARY_USE_VELY}, \\
\nmitem{ATMOS_BOUNDARY_USE_POTT}, and \nmitem{ATMOS_BOUNDARY_USE_QV} are only for the top boundary in this case.
