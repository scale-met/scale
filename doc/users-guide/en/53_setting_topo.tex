...
The details for the file types are described in Section \ref{sec:userdata}.

For the ``GrADS'' type, \nmitem{USERFILE_GrADS_FILENAME} is used to set the namelist file containing the information of the \grads binary data.
...
For the ``TILE'' type, \nmitem{USERFILE_CATALOGUE} is used to set the cataloue file containing information of the name of individual tiled data files and the area which the tiled data covers.
