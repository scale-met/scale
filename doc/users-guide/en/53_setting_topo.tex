...
By specifying \nmitem{CNVTOPO_smooth_maxslope_ratio}, you can set $\theta_{\max}$ directly. Or, you can use the parameter \nmitem{CNVTOPO_smooth_maxslope}, which determines the maximum angle in degree.
...
\verb|USERFILE_IN_DATATYPE  = "INT16",               | & ; Type of the data (INT8,INT16,INT32,REAL32) \\
...
The user-defined data must be a simple binary as same as the format for \grads.
