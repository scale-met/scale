...
according to the topographical difference between the parent model and the SCALE-RM.
In general, topographies of the parent model and the SCALE-RM are different.
...
For example, if the topography made by the SCALE-RM is $\Delta h$ higher than that of the parent model,
soil temperature and land surface temperature is uniformly reduced by $\Delta h\Gamma$,
