...
If \nmitem{BASENAME_BOUNDARY} is null, the boundary files are not outputed.
...
\begin{table}[bth]
\begin{center}
\caption{Variable list of \nmitem{item} in \namelist{grdvar}. The asterisk means ``required.'' When you target on the place at high altitude, use of \texttt{HGT} is recommended.}
