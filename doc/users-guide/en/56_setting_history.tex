...
Monitor component outputs global domain total of variables such as dry airmass, water vapor, total energy, surface precipitation flux, and so on.
...
The time interval of monitor output is determined by the time step specified in the \nmitem{MONITOR_STEP_INTERVAL}.
