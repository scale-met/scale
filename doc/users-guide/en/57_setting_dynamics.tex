...
For advection of prognostic variables in dynamics, the default value is \nmitem{CD4} in the SCALE-RM.
When using this scheme, it is often confirmed that grid-scale convection is occurred on the mountain.
This grid-scale convection is moderated by using \nmitem{UD3}. So, the use of \nmitem{UD3} is recommended.
\nmitem{ATMOS_DYN_NUMERICAL_DIFF_COEF} should be set to zero when using \nmitem{UD3}.
