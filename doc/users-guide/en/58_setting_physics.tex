...
variables in Table \ref{tab:var_list_atm_rd_offline} must be given.
\begin{table}[h]
\begin{center}
  ...
  \begin{tabularx}{150mm}{lXX} \hline
    \rowcolor[gray]{0.9}  Variable name & Description & \# of dimensions \\ \hline
      \verb|SFLX_LW_up|      & upward long-wave radiative flux at the surface & 2D \\
      \verb|SFLX_LW_dn_dir|  & downward long-wave direct radiative flux at the surface & 2D \\
      \verb|SFLX_LW_dn_diff| & downward long-wave diffuse radiative flux at the surface & 2D \\
      \verb|SFLX_SW_up|      & upward short-wave radiative flux at the surface & 2D \\
      \verb|SFLX_SW_dn_dir|  & downward short-wave direct radiative flux at the surface & 2D \\
      \verb|SFLX_SW_dn_diff| & downward shot-wave diffuse radiative flux at the surface & 2D \\
      \verb|RFLX_LW_up|      & upward long-wave radiative flux & 3D \\
      \verb|RFLX_LW_dn|      & downward long-wave radiative flux & 3D \\
      \verb|RFLX_SW_up|      & upward short-wave radiative flux & 3D \\
      \verb|RFLX_SW_dn|      & downward short-wave radiative flux & 3D \\
    \hline
  \end{tabularx}
\end{center}
\end{table}
...
\verb| ATMOS_PHY_RD_OFFLINE_BASENAME              = "radiation", | & ; file name \\
\verb| ATMOS_PHY_RD_OFFLINE_AXISTYPE              = "XYZ",       | & ; dimensions of the data \\
...
\verb| ATMOS_PHY_RD_OFFLINE_STEP_FIXED            = -1,          | & ; step number when data at a cirtain time step is used \\
\verb| ATMOS_PHY_RD_OFFLINE_CHECK_COORDINATES     = .false,      | & ; whether coordinate variables are to be checked \\
\verb| ATMOS_PHY_RD_OFFLINE_STEP_LIMIT            = 1800,        | & ; maximum limit of steps \\
\verb|/|            & \\
}
...
\editboxtwo{
 ...
 \verb| OCEAN_PHY_FILE_basename   = "../init/output/ocean_d01", | & ; input file \\
 ...
 \verb| OCEAN_PHY_FILE_STEP_FIXED            = -1,              | & ; step number when data at a cirtain time step is used \\
 \verb| OCEAN_PHY_FILE_CHECK_COORDINATES     = .false,          | & ; whether coordinate variables are to be checked \\
 \verb| OCEAN_PHY_FILE_STEP_LIMIT            = 100,             | & ; maximum limit of steps \\
 \verb|/                                         | & \\
}
