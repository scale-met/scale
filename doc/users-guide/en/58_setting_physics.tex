...
\verb| ATMOS_PHY_RD_OFFLINE_DIFFUSE_RATE          = 0.5D0,       | & ; diffuse rate of short wave used when short-wave direct flux data is not given \\
\verb|/|            & \\
}
...
\begin{center}
  ...
  \begin{tabularx}{150mm}{lXll} \hline
    \rowcolor[gray]{0.9}  Variable name & Description & \# of dimensions & \\ \hline
      ...
      \verb|SFLX_LW_dn|     & downward long-wave radiative flux at the surface & 2D \\
      \verb|SFLX_SW_up|     & upward short-wave radiative flux at the surface & 2D \\
      \verb|SFLX_SW_dn|     & downward short-wave radiative flux at the surface & 2D \\
      \verb|SFLX_SW_dn_dir| & downward short-wave direct radiative flux at the surface & 2D & optional \\
    \hline
  \end{tabularx}
\end{center}
\end{table}
