...
The parameter files were updated in version 5.2. We recccomend the source codes upper version 5.2 is used with the updated parameter files.
If you want to use the old version of the parameter files in the new source codes, you should specify "nptype" and "nradius" as 11 and 6, respectively,
in \namelist{PARAM_ATMOS_PHY_RD_MSTRN}.\\
