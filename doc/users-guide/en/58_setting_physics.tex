...
The solar radiation is calculated by using date, time, latitude, and longitude according to the model setting of calculation.
...
the radiation process is calculated using the date and time specified at \nmitem{ATMOS_SOLARINS_date} (y,m,d,h,m,s).
The date and time with negative value in \nmitem{ATMOS_SOLARINS_date} are replaced by those in the model date.
For example,
