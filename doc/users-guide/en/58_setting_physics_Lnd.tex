...
heat enegy fluxes are calculated by the given surface temperature.
The residuals of heat balance are forced into the sub-surface heat flux of the land model.
The surface temperature is the same as the sub-surface temperature at the 1st layer of land model
which is determined by the land model physics.
