...
\msgbox{
\verb|ERROR [CPL_vars_setup] Ocean fraction exists, but ocean component has not been called. Please check this inconsistency. STOP.| \\
}
...
\msgbox{
\verb|ERROR [CPL_vars_setup] Land fraction exists, but land component has not been called. Please check this inconsistency. STOP.| \\
}
...
\msgbox{
\verb|ERROR [CPL_vars_setup] Urban fraction exists, but urban component has not been called. Please check this inconsistency. STOP.| \\
}
