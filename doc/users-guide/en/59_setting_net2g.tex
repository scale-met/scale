...
\texttt{scale-\version/scale-rm/util/netcdf2grads\_h/}. In this section, only the major issues pertaining to its use are treated. Refer to the sample files \verb|net2g.all.conf| in \texttt{scale-\version/scale-rm/util/netcdf2grads\_h/} for the other options.
