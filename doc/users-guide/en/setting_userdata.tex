\section{How to prepare user-defined data} \label{sec:userdata}
...
Set \nmitem{CNVERT_USER} = \verb|.true.| in \namelist{PARAM_CONVERT} to enable the data conversion in the execution of \verb|scale-rm_init|.
...
The \verb|TILE|-type data is horizontally decomposed tiled data.
