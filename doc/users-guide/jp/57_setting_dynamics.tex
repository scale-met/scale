...
\begin{center}
  ...
  \begin{tabularx}{150mm}{llXX} \hline
    ...
    & \multicolumn{1}{l}{\verb|RK3WS2002|} & \multicolumn{2}{l}{Wicker and Skamarock (2002) 3段ルンゲ・クッタスキーム(一般に2次精度)} \\
    & \multicolumn{1}{l}{\verb|RK4|} & \multicolumn{2}{l}{4次精度の4段ルンゲ・クッタスキーム} \\
    & \multicolumn{1}{l}{\verb|RK7s6o|} & \multicolumn{2}{l}{6次精度の7段ルンゲ・クッタスキーム（Butcher (1964))} \\
    \hline
