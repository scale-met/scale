...
\verb| ATMOS_PHY_RD_OFFLINE_DIFFUSE_RATE          = 0.5D0,       | & ; 下向き直達短波データを与えない場合に使われる散乱率 \\
\verb|/|            & \\
\end{tabularx}
}}}\\
...
\begin{center}
  ...
  \begin{tabularx}{150mm}{lXll} \hline
    \rowcolor[gray]{0.9}  変数名 & 変数の説明 & 次元数 & \\ \hline
      ...
      \verb|SFLX_LW_dn|     & 地表面下向き長波放射    & 2次元 \\
      \verb|SFLX_SW_up|     & 地表面上向き短波放射    & 2次元 \\
      \verb|SFLX_SW_dn|     & 地表面下向き短波放射    & 2次元 \\
      \verb|SFLX_SW_dn_dir| & 地表面下向き直達短波放射 & 2次元 & オプション \\
    \hline
  \end{tabularx}
\end{center}
\end{table}
