...
入力ファイルの総数や2次元トポロジー等情報は、1番目のファイル
(この例では\verb|history_d02.pe000000.nc|)から読み込まれる。
...
その他の\namelist{PARAM_SNOPLGIN_HGRIDOPE}のオプションでは、出力領域の境界や格子点数を設定する。
