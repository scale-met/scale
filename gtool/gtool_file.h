...
extern int32_t file_get_nvars( int32_t  fid,    // (in)
                               int32_t *nvars );// (out)

extern int32_t file_get_varname( int32_t  fid,     // (in)
                                 int32_t  vid,     // (in)
                                 char    *name,    // (out)
                                 int32_t  len    );// (in)
...
extern int32_t file_get_attribute_text( int32_t  fid,   // (in)
                                        char    *vname, // (in)
                                        char    *key,   // (in)
                                        char    *value, // (out)
                                        int32_t  len);  // (in)

extern int32_t file_get_attribute_int( int32_t  fid,    // (in)
                                       char    *vname,  // (in)
                                       char    *key,    // (in)
                                       int32_t *value,  // (out)
                                       size_t   len);   // (in)

extern int32_t file_get_attribute_float( int32_t  fid,   // (in)
                                         char    *vname, // (in)
                                         char    *key,   // (in)
                                         float   *value, // (out)
                                         size_t   len);  // (in)

extern int32_t file_get_attribute_double( int32_t  fid,   // (in)
                                          char    *vname, // (in)
                                          char    *key,   // (in)
                                          double  *value, // (out)
                                          size_t   len);  // (in)

extern int32_t file_set_attribute_text( int32_t  fid,    // (in)
                                        char    *vname,  // (in)
                                        char    *key,    // (in)
                                        char    *value); // (in)

extern int32_t file_set_attribute_int( int32_t  fid,   // (in)
                                       char    *vname, // (in)
                                       char    *key,   // (in)
                                       int32_t *value, // (in)
                                       size_t   len);  // (in)

extern int32_t file_set_attribute_float( int32_t  fid,   // (in)
                                         char    *vname, // (in)
                                         char    *key,   // (in)
                                         float   *value, // (in)
                                         size_t   len);  // (in)

extern int32_t file_set_attribute_double( int32_t  fid,   // (in)
                                          char    *vname, // (in)
                                          char    *key,   // (in)
                                          double  *value, // (in)
                                          size_t   len);  // (in)
