...
export EXE=scale3_1256x28x28_ndw6_${postfix}

export OUTDIR=${HMDIR}/output/${postfix}/test1_005h_hydrostatic
...
&PARAM_ATMOS_VARS
 ATMOS_RESTART_IN_BASENAME      = "../init1_005h_hydrostatic/init1_hydrostatic_63072000000.000",
