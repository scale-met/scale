...
export EXE=scale3_436x14x14_ndw6_${postfix}

export OUTDIR=${HMDIR}/output/${postfix}/test1_005m_hydrostatic
...
&PARAM_ATMOS_VARS
 ATMOS_RESTART_IN_BASENAME      = "../init1_005m_hydrostatic/init1_hydrostatic_63072000000.000",
