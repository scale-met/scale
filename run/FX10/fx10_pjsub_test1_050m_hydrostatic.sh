...
export EXE=scale3_206x21x21_ndw6_${postfix}

export OUTDIR=${HMDIR}/output/${postfix}/test1_050m_hydrostatic
...
&PARAM_ATMOS_VARS
 ATMOS_RESTART_IN_BASENAME      = "../init1_050m_hydrostatic/init1_hydrostatic_63072000000.000",
