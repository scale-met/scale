...
export EXE=scale3_42x56x56_ndw6_${postfix}

export OUTDIR=${HMDIR}/output/${postfix}/test1_500m_hydrostatic
...
&PARAM_ATMOS_VARS
 ATMOS_RESTART_IN_BASENAME      = "../init1_500m_hydrostatic/init1_hydrostatic_63072000000.000",
