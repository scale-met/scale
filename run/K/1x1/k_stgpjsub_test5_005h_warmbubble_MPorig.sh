...
#PJM --stgin  "rank=* /data1/user0117/scale3/bin/K/MPorig_1256x32x32_ndw6_              %r:./"
#PJM --stgout "rank=* %r:./* /data1/user0117/scale3/output/MPorig_test5_005h_warmbubble_1x1/"
#PJM -s
#
...
outdir=/data1/user0117/scale3/output/MPorig_test5_005h_warmbubble_1x1
mkdir -p ${outdir}

# run
         mpiexec ${LPG} ./scale3_init_1256x32x32_ndw6_ ./scale3_init5_005h_warmbubble.cnf
${fprof} mpiexec ${LPG} ./MPorig_1256x32x32_ndw6_     ./scale3_test5_005h_warmbubble.cnf
