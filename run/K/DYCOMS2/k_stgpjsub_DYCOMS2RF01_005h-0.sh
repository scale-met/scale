...
#PJM --stgout "rank=* %r:./* /data1/user0117/scale3/output/DYCOMS2RF01_005m438x8x8_ndw6_96x96-0/"
#PJM -s
#
...
outdir=/data1/user0117/scale3/output/DYCOMS2RF01_005m438x8x8_ndw6_96x96-0
mkdir -p ${outdir}
