...
&PARAM_ATMOS_VARS
 ...
 ATMOS_RESTART_CHECK_BASENAME = '${HMDIR}/data/supercell/check_supercell_63072000006.000',
/
...
&PARAM_HISTORY
 ...
 HISTORY_DEFAULT_TINTERVAL = 4.0D0,
