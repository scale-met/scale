...
export EXE=MPTBtune
LD_STAGE=`/work/system/bin/stage $BIN/$EXE`

export OUTDIR=${HMDIR}/output/MPTBtune_32x96
...
fpcoll -Ihwm,cpu -l0 -o Basic_Profile.txt -m 200000                        mpiexec $LPG $LD_STAGE $EXE.cnf
