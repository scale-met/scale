...
export EXE=Microphysics_work

export OUTDIR=${HMDIR}/output/MPtune_work
...
&PARAM_ATMOS_VARS
 ATMOS_QTRC_NMAX              = 11,
 ATMOS_RESTART_IN_BASENAME    = "${HMDIR}/output/MPTB_KESSLER/init_MPTB_63072000510.000",
...
&PARAM_HISTORY
 ...
 HISTORY_DEFAULT_TINTERVAL = 1.0D0,
