...
export OUTDIR=${HMDIR}/output/coldbubble_new
...
&PARAM_TIME
 ...
 TIME_STARTMS               = 0.D0,
 TIME_DURATION              = 17.0D0,
 TIME_DURATION_UNIT         = "SEC",
 TIME_DT                    = 1.7D0,
 TIME_DT_UNIT               = "SEC",
 TIME_DT_ATMOS_DYN          = 1.7D0,
 TIME_DT_ATMOS_DYN_UNIT     = "SEC",
 TIME_NSTEP_ATMOS_DYN       = 1,
 TIME_DT_ATMOS_PHY_MP       = 1.7D0,
 TIME_DT_ATMOS_PHY_MP_UNIT  = "SEC",
 TIME_DT_ATMOS_RESTART      = 170.0D0,
...
&PARAM_ATMOS_VARS
 ATMOS_QTRC_NMAX              = 11,
 ATMOS_RESTART_IN_BASENAME    = "${HMDIR}/output/init_coldbubble_new/init_coldbubble_63072000000.000",
...
&PARAM_HISTORY
 ...
 HISTORY_DEFAULT_TINTERVAL = 1.7D0,
