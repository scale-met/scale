...
export OUTDIR=${HMDIR}/data/SmagorinskyAndSurface_lores
...
&PARAM_TIME
 ...
 TIME_DT_ATMOS_PHY_TB       = 5.D0,
 TIME_DT_ATMOS_PHY_TB_UNIT  = 'SEC',
 TIME_DT_ATMOS_RESTART      = 200.D0,
...
&PARAM_HISTORY
 ...
 HISTORY_DEFAULT_TINTERVAL = 5.D0,
