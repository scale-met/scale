...
export OUTDIR=${HMDIR}/output/scale3_2x1

# Run Command
export RUN="fpcoll -Ibalance,call,cpu,hwm, -l20 -i20 -o Basic_Profile.txt -m 200000 mpiexec $LPG $BIN/$EXE scale3.cnf"
...
&PARAM_TIME
 ...
 TIME_DT                    = 75D0,
 TIME_DT_UNIT               = 'MSEC',
 TIME_DT_ATMOS_DYN          = 75D0,
 TIME_DT_ATMOS_DYN_UNIT     = 'MSEC',
 TIME_NSTEP_ATMOS_DYN       = 1,
 TIME_DT_ATMOS_RESTART      = 10.D0,
...
&PARAM_ATMOS_VARS
 ...
 ATMOS_RESTART_CHECK_BASENAME = '${HMDIR}/data/coldbubble/check_63072000010.000',
/
...
&PARAM_HISTORY
 ...
 HISTORY_DEFAULT_TINTERVAL = 2.5D0,
