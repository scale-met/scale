...
!  v6.1: abandon the test parameter and Tsurf is changed to be an input parameter
!
...
SUBROUTINE SIMPLE_PHYSICS(pcols, pver, dtime, lat, Tsurf, t, q, u, v, pmid, pint, pdel, rpdel, ps, precl, RJ2012_precip, TC_PBL_mod, use_HS)
...
!
   ...
   real(r8), intent(in) :: Tsurf(pcols) ! Sea Surface Temperature
