...
!OCL XFILL
  ...
  subroutine ATMOS_PHY_MP_step( &
    ...
    real(RP), intent(out) :: DENS_t_MP (KA,IA,JA)
    real(RP), intent(out) :: MOMZ_t_MP (KA,IA,JA)
    real(RP), intent(out) :: MOMX_t_MP (KA,IA,JA)
    real(RP), intent(out) :: MOMY_t_MP (KA,IA,JA)
    real(RP), intent(out) :: RHOT_t_MP (KA,IA,JA)
    real(RP), intent(out) :: RHOQ_t_MP (KA,IA,JA,QA)
...
!OCL XFILL
    ...
    return
  end subroutine ATMOS_PHY_MP_step
