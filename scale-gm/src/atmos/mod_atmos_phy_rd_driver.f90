...
!! @li      2017-12-23 (K.Kikuchi)    [modify]
!<
!-------------------------------------------------------------------------------
...
!OCL XFILL
  ...
  subroutine ATMOS_PHY_RD_step( &
    ...
    use mod_atmos_phy_sf_vars, only: &
       ...
       SFC_albedo  => ATMOS_PHY_SF_SFC_albedo
    use mod_atmos_phy_rd_vars, only: &
       RHOT_t_RD0   => ATMOS_PHY_RD_RHOT_t,       &
       SFCFLX_LW_up => ATMOS_PHY_RD_SFLX_LW_up,   &
       SFCFLX_LW_dn => ATMOS_PHY_RD_SFLX_LW_dn,   &
       SFCFLX_SW_up => ATMOS_PHY_RD_SFLX_SW_up,   &
       SFCFLX_SW_dn => ATMOS_PHY_RD_SFLX_SW_dn,   &
    ...
    logical, intent(in) :: update_flag
    real(RP), intent(out) :: RHOT_t_rd (KA,IA,JA)
...
!OCL XFILL
    ...
    RHOT_t_rd0 = RHOT_t_rd

    return
  end subroutine ATMOS_PHY_RD_step
