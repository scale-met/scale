...
module mod_atmos_phy_ch_vars
  ...
  !
  logical,                private :: ATMOS_PHY_CH_RESTART_OUTPUT       = .false.                !< output restart file?
  character(len=H_LONG),  private :: ATMOS_PHY_CH_RESTART_IN_BASENAME  = ''                     !< basename of the restart file
  character(len=H_LONG),  private :: ATMOS_PHY_CH_RESTART_OUT_BASENAME = ''                     !< basename of the output file
  character(len=H_MID),   private :: ATMOS_PHY_CH_RESTART_OUT_TITLE    = 'ATMOS_PHY_CH restart' !< title    of the output file
  character(len=H_MID),   private :: ATMOS_PHY_CH_RESTART_OUT_DTYPE    = 'DEFAULT'              !< REAL4 or REAL8
