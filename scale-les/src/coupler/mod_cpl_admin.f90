...
module mod_cpl_admin
  ...
  logical,                public :: CPL_OCN_SFC_TEMP_UPDATE = .false. !< update Ocean Surface Temperature?
  logical,                public :: CPL_LND_SFC_TEMP_UPDATE = .false. !< update Land  Surface Temperature?
  logical,                public :: CPL_URB_SFC_TEMP_UPDATE = .false. !< update Urban Surface Temperature?
