...
!      call bulkcoef_uno( &
  ...
  subroutine bulkcoef_beljaars( &
    ...
    if( n > nmax ) then
      write(*,*) 'Error: reach maximum iteration in the function of bulkcoef_beljaars.'
    end if
    ...
    return
  end subroutine bulkcoef_beljaars
