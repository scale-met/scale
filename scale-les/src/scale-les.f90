...
program scaleles_launcher
  ...
  integer :: REF_COL2DOM(0:max_depth)     ! refering from color to domain
  integer :: REF_DOMAIN(max_depth)        ! refering from color to domain
  integer :: REF_DOM2ORDER(max_depth)     ! refering from domain to order
