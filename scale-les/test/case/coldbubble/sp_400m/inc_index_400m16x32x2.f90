  ...
  !-----------------------------------------------------------------------------
  !
  !++ SCALE-LES grid parameters (400m res)
  !
  !-----------------------------------------------------------------------------
  ...
  real(RP), private, save      :: DX        =  400.0_RP ! length in the main region [m]: x
  real(RP), private, save      :: DY        =  400.0_RP ! length in the main region [m]: y
