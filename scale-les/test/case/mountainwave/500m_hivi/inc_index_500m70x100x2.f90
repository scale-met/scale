  ...
  !-----------------------------------------------------------------------------
  !
  !++ SCALE-LES grid parameters (500m res., 11km unisotropic, 21km model top)
  !
  !-----------------------------------------------------------------------------
  integer,  private, parameter :: KMAX =   70 ! # of computational cells: z
  ...
  real(RP), private, save      :: DZ        =  300.0_RP ! length in the main region [m]: z
