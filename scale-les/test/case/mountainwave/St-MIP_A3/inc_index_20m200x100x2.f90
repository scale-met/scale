  ...
  !-----------------------------------------------------------------------------
  !
  !++ SCALE-LES grid parameters (St-MIP A3 case, 4km height, 2km buffer)
  !
  !-----------------------------------------------------------------------------
  ...
  real(RP), private, save      :: DZ        =   20.0_RP ! length in the main region [m]: z
  real(RP), private, save      :: DX        =   20.0_RP ! length in the main region [m]: x
  real(RP), private, save      :: DY        =   20.0_RP ! length in the main region [m]: y
