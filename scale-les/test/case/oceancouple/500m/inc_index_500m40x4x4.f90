  ...
  !-----------------------------------------------------------------------------
  !
  !++ SCALE-LES grid parameters ( 500m res., 15km isotropic, 20km model top)
  !
  !-----------------------------------------------------------------------------
  integer,  private, parameter :: KMAX =   40 ! # of computational cells: z
  integer,  private, parameter :: IMAX =    4 ! # of computational cells: x
  integer,  private, parameter :: JMAX =    4 ! # of computational cells: y

  integer,  private, parameter :: IBLOCK =  4 ! block size for cache blocking: x
  integer,  private, parameter :: JBLOCK =  4 ! block size for cache blocking: y
