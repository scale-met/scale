...
mpirun -np 4 /home/tyamaura/scale/scale-les/test/case_real/check_mass/init/scale-les_init init.d01.conf || exit
mpirun -np 4 /home/tyamaura/scale/scale-les/test/case_real/check_mass/init/scale-les_init init.d02.conf || exit
