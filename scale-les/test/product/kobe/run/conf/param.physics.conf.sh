...
&PARAM_ATMOS_PHY_RD_MSTRN
 ...
 ATMOS_PHY_RD_MSTRN_GASPARA_IN_FILENAME   = "${RADDIR}/PARAG.29",
 ATMOS_PHY_RD_MSTRN_AEROPARA_IN_FILENAME  = "${RADDIR}/PARAPC.29",
 ATMOS_PHY_RD_MSTRN_HYGROPARA_IN_FILENAME = "${RADDIR}/VARDATA.RM29",
 ATMOS_PHY_RD_MSTRN_NBAND                 = 29,
/

&PARAM_ATMOS_PHY_RD_PROFILE
 ATMOS_PHY_RD_PROFILE_TOA                   = 100.D0,
 ATMOS_PHY_RD_PROFILE_CIRA86_IN_FILENAME    = "${RADDIR}/cira.nc",
 ATMOS_PHY_RD_PROFILE_MIPAS2001_IN_BASENAME = "${RADDIR}/MIPAS",
 DEBUG                                      = .true.,
/
