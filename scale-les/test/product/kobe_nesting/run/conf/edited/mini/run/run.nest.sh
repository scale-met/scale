...
#-------------------------------------------------------------------------------
#>>> DOMAIN 2
#PJM --stgin  "rank=0 ../config/run.d02.conf                             %r:../"
#PJM --stgin  "rank=0 ../init/domain_02/init_d02_00023587200.000.pe*.nc  %r:../"
#--- --stgin  "rank=0 ../init/domain_02/boundary_d02.pe*.nc              %r:../"
#PJM --stgin  "rank=0 ../input/domain_02/topo_d02.pe*.nc                 %r:../"
#PJM --stgin  "rank=0 ../input/domain_02/landuse_d02.pe*.nc              %r:../"
#>>> DOMAIN 3
#PJM --stgin  "rank=0 ../config/run.d03.conf                             %r:../"
#PJM --stgin  "rank=0 ../init/domain_03/init_d03_00023587200.000.pe*.nc  %r:../"
#--- --stgin  "rank=0 ../init/domain_03/boundary_d03.pe*.nc              %r:../"
#PJM --stgin  "rank=0 ../input/domain_03/topo_d03.pe*.nc                 %r:../"
#PJM --stgin  "rank=0 ../input/domain_03/landuse_d03.pe*.nc              %r:../"
#>>> DOMAIN 4
#PJM --stgin  "rank=0 ../config/run.d04.conf                             %r:../"
#PJM --stgin  "rank=0 ../init/domain_04/init_d04_00023587200.000.pe*.nc  %r:../"
#--- --stgin  "rank=0 ../init/domain_04/boundary_d04.pe*.nc              %r:../"
#PJM --stgin  "rank=0 ../input/domain_04/topo_d04.pe*.nc                 %r:../"
#PJM --stgin  "rank=0 ../input/domain_04/landuse_d04.pe*.nc              %r:../"

#>>> COMMON FILES
#PJM --stgin  "rank=0 /data/ra000006/a00000/scale/src/bin/scale-les       0:../"
...
${fprof} mpiexec -n 2 ./scale-les run.d01.conf || exit 1
