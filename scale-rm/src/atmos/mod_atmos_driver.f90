...
contains
  ...
  subroutine ATMOS_driver_tracer_setup
    ...
    if( IO_L ) write(IO_FID_LOG,*) '++++++ Module[TRACER SETUP] / Categ[ATMOS] / Origin[SCALE-RM]'
  ...
  subroutine ATMOS_driver_calc_tendency( force )
    ...
    if( IO_L ) write(IO_FID_LOG,*)
    if( IO_L ) write(IO_FID_LOG,*) '++++++ Module[CALC TEND] / Categ[ATMOS DRIVER] / Origin[SCALE-RM]'
...
!OCL XFILL
  ...
  subroutine ATMOS_driver_calc_tendency_from_sflux( force )
    ...
    if( IO_L ) write(IO_FID_LOG,*)
    if( IO_L ) write(IO_FID_LOG,*) '++++++ Module[CALC TEND from SFLUX] / Categ[ATMOS DRIVER] / Origin[SCALE-RM]'
