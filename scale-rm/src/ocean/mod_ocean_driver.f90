...
!OCL XFILL
  ...
  subroutine OCEAN_SURFACE_GET
    ...
    ATMOS_SFLX_SW  (:,:) = ATMOS_SFLX_rad_dn(:,:,I_SW,1) + ATMOS_SFLX_rad_dn(:,:,I_SW,2) ! direct+diffuse
    ATMOS_SFLX_LW  (:,:) = ATMOS_SFLX_rad_dn(:,:,I_LW,1) + ATMOS_SFLX_rad_dn(:,:,I_LW,2) ! direct+diffuse
