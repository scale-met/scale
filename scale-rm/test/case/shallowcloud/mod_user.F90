...
contains
  ...
  subroutine USER_setup
    ...
    elseif( USER_LS_TYPE == 'BOMEX' ) then ! BOMEX
       ...
       LOG_ERROR("USER_setup",*) 'Not appropriate type for USER_LS_TYPE. STOP.', trim(USER_LS_TYPE)
       call PRC_abort
    endif
  ...
  subroutine USER_calc_tendency
    ...
    LOG_INFO("USER_calc_tendency",*) 'Atmos physics  step: Large scale sinking'
    ...
    if ( do_phy_rd ) then
       if ( USER_LS_TYPE == 'DYCOMS2_RF01' .OR. USER_LS_TYPE == 'DYCOMS2_RF02' ) then
          ...
          LOG_INFO("USER_calc_tendency",*) 'Atmos physics  step: Parametarized Radiation (DYCOMS-II)'
       ...
       elseif( USER_LS_TYPE == 'RICO' ) then
          ...
          LOG_INFO("USER_calc_tendency",*) 'Atmos physics  step: Parametarized Radiation (RICO)'
       ...
       elseif( USER_LS_TYPE == 'BOMEX' ) then
          ...
          LOG_INFO("USER_calc_tendency",*) 'Atmos physics  step: Parametarized Radiation (BOMEX)'
    ...
    if ( do_phy_sf ) then
       if ( USER_LS_TYPE == 'RICO' ) then
          ...
          LOG_INFO("USER_calc_tendency",*) 'Atmos physics  step: Surface flux (RICO)'
       ...
       elseif ( USER_LS_TYPE == 'BOMEX' ) then
          ...
          LOG_INFO("USER_calc_tendency",*) 'Atmos physics  step: Surface flux (BOMEX)'
