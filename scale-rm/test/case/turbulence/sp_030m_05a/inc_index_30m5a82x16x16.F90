  !-----------------------------------------------------------------------------
  !
  !++ SCALE-RM grid parameters (res. 30m, asp. 5)
  !
  !-----------------------------------------------------------------------------
  real(RP), private, parameter :: DZ  =  30 ! length in the main region [m]: z
  real(RP), private, parameter :: DX  = 150 ! length in the main region [m]: x
  real(RP), private, parameter :: DY  = 150 ! length in the main region [m]: y
