...
xz_PT_t0250 = VarNoAnimFig.new("", "PT", "time=250,y=0",  "0.2", "299:303", "xz", "t0250","") 
xz_PT_t0500 = VarNoAnimFig.new("", "PT", "time=500,y=0",  "0.2", "299:303", "xz", "t0500","") 
xz_PT_t0750 = VarNoAnimFig.new("", "PT", "time=750,y=0",  "0.2", "299:303", "xz", "t0750","") 
xz_PT_t1000 = VarNoAnimFig.new("", "PT", "time=1000,y=0",  "0.2", "299:303", "xz", "t1000","")

xz_U_t0250 = VarNoAnimFig.new("", "U", "time=250,y=0",  "2", "-20:40", "xz", "t0250","") 
xz_U_t0500 = VarNoAnimFig.new("", "U", "time=500,y=0",  "2", "-20:40", "xz", "t0500","") 
xz_U_t0750 = VarNoAnimFig.new("", "U", "time=750,y=0",  "2", "-20:40", "xz", "t0750","") 
xz_U_t1000 = VarNoAnimFig.new("", "U", "time=1000,y=0",  "2", "-20:40", "xz", "t1000","") 

xz_W_t0250 = VarNoAnimFig.new("", "W", "time=250,y=0",  "2", "-20:20", "xz", "t0250","") 
xz_W_t0500 = VarNoAnimFig.new("", "W", "time=500,y=0",  "2", "-20:20", "xz", "t0500","") 
xz_W_t0750 = VarNoAnimFig.new("", "W", "time=750,y=0",  "2", "-20:20", "xz", "t0750","") 
xz_W_t1000 = VarNoAnimFig.new("", "W", "time=1000,y=0",  "2", "-20:20", "xz", "t1000","") 

exps = []
resols = ["125m"]#"500m", "250m", "125m"]
...
noAnimFigVars = []
exp_noAnimFigs =  [ \
                    xz_PT_t0250, xz_PT_t0500, xz_PT_t0750, xz_PT_t1000, \
                    xz_U_t0250, xz_U_t0500, xz_U_t0750,  xz_U_t1000,    \
                    xz_W_t0250, xz_W_t0500, xz_W_t0750, xz_W_t1000,    \
                  ]
