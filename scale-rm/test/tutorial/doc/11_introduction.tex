...
netcdf4ファイル I/O
 \item 外部データ読み込みによる初期値・境界値データ作成
   \begin{itemize}
    \item WRF-ARW\footnote{http://www.wrf-model.org}、
NICAM\footnote{http://nicam.jp}、
その他GrADS\footnote{http://cola.gmu.edu/grads/}フォーマットでの入力に対応
   \end{itemize}
 \item 出力はすべてNetCDF3またはNetCDF4。
\end{itemize}
...
\begin{itemize}
 ...
 \item 数値解法: 陽解法と陰解法の両方を実装
   \begin{itemize}
    \item 完全陽解法(HE-VE:Horizontally Explicit and Vertically Explicit method)
