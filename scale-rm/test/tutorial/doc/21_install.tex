...
ここでは第\ref{chap:tutorial_ideal}章と第\ref{chap:tutorial_reall}章の
...
第\ref{chap:tutorial_ideal}章、第\ref{chap:tutorial_reall}章のチュートリアルは、
それらのライブラリ環境がインストールされていることを前提として進める。

描画ツールとして、
第\ref{chap:tutorial_ideal}章、第\ref{chap:tutorial_reall}章のチュートリアルでは
...
第\ref{chap:tutorial_ideal}章、第\ref{chap:tutorial_reall}章のチュートリアルでも使用する。
