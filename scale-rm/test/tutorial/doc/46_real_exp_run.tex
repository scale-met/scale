...
\verb|&HISTITEM item="MOMZ" /| 　  　        　& 鉛直運動量 (3次元) \\
\verb|&HISTITEM item="MOMX" /| 　  　        　& X方向水平運動量 (3次元) \\
\verb|&HISTITEM item="MOMY" /| 　  　        　& Y方向水平運動量 (3次元) \\
\verb|&HISTITEM item="RHOT" /| 　  　        　& 密度X温位 (3次元) \\
...
\verb|&HISTITEM item="LAND_SFC_TEMP" /| 　　  & 陸面での地表面温度 (2次元) \\
\verb|&HISTITEM item="URBAN_SFC_TEMP"/|　　　 & 都市での地表面温度 (2次元) \\
\end{tabularx}
}}}\\
