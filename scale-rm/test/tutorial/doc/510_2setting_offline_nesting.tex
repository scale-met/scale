...
この設定を\verb|run.d01.conf|に適用すると下記のようになる。\textcolor{red}{赤文字}で示した部分が、上記の注意点・変更点に対応する部分である。\\
...
\textcolor{red}{\verb| BASENAME_ORG        = "history",|}  & \verb|run.d01.conf|の\verb|HISTORY_DEFAULT_BASENAME|\\
...
\textcolor{red}{\verb| OFFLINE_PARENT_PRC_NUM_X  = 4,|}  & \verb|run.d01.conf|の\verb|PRC_NUM_X|\\
\textcolor{red}{\verb| OFFLINE_PARENT_PRC_NUM_Y  = 4,|}  & \verb|run.d01.conf|の\verb|PRC_NUM_Y|\\
\textcolor{red}{\verb| OFFLINE_PARENT_KMAX       = 35,|} & \verb|run.d01.conf|の\verb|KMAX|\\
\textcolor{red}{\verb| OFFLINE_PARENT_IMAX       = 40,|} & \verb|run.d01.conf|の\verb|IMAX|\\
\textcolor{red}{\verb| OFFLINE_PARENT_JMAX       = 40,|} & \verb|run.d01.conf|の\verb|JMAX|\\
\textcolor{red}{\verb| OFFLINE_PARENT_LKMAX      = 5,|}  & \verb|run.d01.conf|の\verb|LKMAX|\\
