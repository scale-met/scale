...
NameList~\verb|PARAM_PRC|内の項目\verb|PRC_NUM_X|、\verb|PRC_NUM_Y|で
水平格子間隔については、NameList~\verb|PARAM_GRD|内の項目\verb|DX|、\verb|DY|で
設定する。
...
NameList~\verb|PARAM_INDEX|内の項目で指定されている。
