...
~\\
\proofcomment{(足立) すみません、この式、、、}\\
%\[
%          BIFFER_X = DX \times BUFFACT + DX \times BUFFACT^2 + ... + DX \times BUFFACT^{ibuff}  \\
%BIFFER_X / BUFFACT = DX + DX \time BUFFACT + ... + DX \times BUFFACT^{ibuff-1}  \\
%BIFFER_X (1 - 1/BUFFACT) = DX \times BUFFACT^{ibuff} - DX\\
%BIFFER_X = DX \times \frac{(BUFFACT^{ibuff} - 1)}{(1- 1/BUFFACT)}\\
%\]
~\\
