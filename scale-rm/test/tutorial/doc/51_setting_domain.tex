...
~\\
\proofcomment{上記の記述は、プロセス１では、500m プロセス2では1000mと記述出来ることになり、
一つの設定ファイルでこの設定を行うということと矛盾しているように思います。}\\
...
\proofcomment{重要な項目であると思います。これらのネームリスト項目について説明を加えてください。}
\replycomment{追記しました(西澤)}
...
\proofcomment{上記本当か？許容する最大傾斜角は、小さすぎないか？degreeでしてしているのですよね？}
\replycomment{わかりづらいので、基本設定はdegreeを止め、倍率で与えるようにしました（山浦）}
