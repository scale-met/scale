...
\subsection{数値解法}
%------------------------------------------------------
設定は、設定ファイルの\verb|PARAM_ATMOS|の\verb|ATMOS_DYN_TYPE|で設定する。\\
...
%------------------------------------------------------
設定は、設定ファイルの\verb|PARAM_ATMOS_DYN|で設定する。
...
f    & \multicolumn{1}{l}{\verb|CD2|} & \multicolumn{1}{l}{2-nd order central difference scheme} & \multicolumn{1}{l}{1}\\
    & \multicolumn{1}{l}{\verb|CD4|} & \multicolumn{1}{l}{4-th order central difference scheme} & \multicolumn{1}{l}{2}\\
    & \multicolumn{1}{l}{\verb|CD6|} & \multicolumn{1}{l}{6-th order central difference scheme} & \multicolumn{1}{l}{3}\\
    & \multicolumn{1}{l}{\verb|UD3|} & \multicolumn{1}{l}{3-rd order upwind difference scheme} & \multicolumn{1}{l}{2}\\
    & \multicolumn{1}{l}{\verb|UD5|} & \multicolumn{1}{l}{5-th order upwind difference scheme} & \multicolumn{1}{l}{3}\\
    & \multicolumn{1}{l}{\verb|UD3KOREN1993|} & \multicolumn{1}{X}{3-rd order upwind difference scheme with Koren (1993) filter} & \\
\hline
  \end{tabularx}
\end{center}
\end{table}
