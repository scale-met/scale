...
\section{インストール方法 (Linux - CentOS 6.6 編)} \label{sec:install_centos}
%==========================================================================================
...
\section{インストール方法 (Linux - CentOS 7.1 編)} \label{sec:install_centos71}
%==========================================================================================
...
\section{インストール方法 (Linux - openSUSE 13.2 編)} \label{sec:install_opensuse}
%==========================================================================================
...
\section{インストール方法(Mac OS X 編)} \label{sec:install_mac} 
...
\section{インストール方法 (スーパーコンピュータ「京」 編)} \label{sec:install_supercom}
%==========================================================================================
...
\section{描画ツールのインストール} \label{sec:install_drawtool}
...
\item GPhys / Ruby-DCL by 地球電脳倶楽部\\
 \begin{itemize}
  ...
  \item インストール方法：本書で使用したCentOS6、CentOS7については、下記のWebページにインストール方法が記載されている。\\
                        ...
                        Mac OS Xにおけるインストール方法は第\ref{sec:install_mac}節で説明する。
 \end{itemize}
