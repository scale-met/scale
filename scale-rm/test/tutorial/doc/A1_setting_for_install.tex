...
\section{インストール方法 (Linux - CentOS 6.6 編)} \label{chap:install_centos}
%==========================================================================================
...
\noindent \textcolor{blue}{\small ＊wgrib、wgrib2は、第\ref{chap:tutorial_reall}章：Tutorial: Real case で
...
\item GPhys / Ruby-DCL by 地球電脳倶楽部\\
 \begin{itemize}
  ...
  \item インストール方法：本書で使用したCentOS6、CentOS7については、下記のWebページにインストール方法が記載されている。\\
                        ...
                        Mac OS Xにおけるインストール方法は第\ref{chap:install_mac}節で説明する。
 \end{itemize}
