...
module mod_sno
  ...
  public :: SNO_gather_globalaxis
  public :: SNO_gather_globalvars
...
!        endif
  ...
  !-----------------------------------------------------------------------------
  subroutine SNO_gather_globalaxis( &
       output_single, &
       nprocs_x_out,  &
       nprocs_y_out,  &
       naxis,         &
    ...
    return
  end subroutine SNO_gather_globalaxis

  !-----------------------------------------------------------------------------
  subroutine SNO_gather_globalvars( &
       output_single, &
       nprocs_x_out,  &
       nprocs_y_out,  &
       dinfo,         &
    ...
    return
  end subroutine SNO_gather_globalvars
