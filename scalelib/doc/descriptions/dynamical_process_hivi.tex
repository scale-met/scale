...
In order to obtain Helmholtz equation, a linearlized diagnostic equation for the density is used instead of Eq. \ref{eq: hivi rho}.
\begin{align}
  \rho^{n+1} &\sim
  \frac{P_{00}}{R\theta^n}\left(\frac{p^{n+1}}{P_{00}}\right)^{\frac{1}{\kappa^n}}
  \sim \frac{1}{\kappa^n} \frac{\rho^n}{p^n} \left\{p^{n+1}-(1-\kappa^n)p^n\right\}.
\end{align}
...
\begin{align}
  ...
  \frac{1}{\Delta t}\left[
    ...
    \right] \nonumber\\&\;\;\;
  + g \frac{\partial}{\partial \xi}\left\{(1-\kappa^n)\frac{J_{33}P^n}{Q^n}\right\}
...
\begin{align}
 ...
 \right) \nonumber\\&
  + \frac{1}{\Delta z_k}\left\{
   (J_{33})_{k+1/2}\hat{\theta}_{k+1/2}\frac{(J_{33})_{k+1}P^{n+1}_{k+1}-J_{33}P^{n+1}}{\Delta k_{k+1/2}}
  -(J_{33})_{k-1/2}\hat{\theta}_{k-1/2}\frac{J_{33}P^{n+1}-(J_{33})_{k-1}P^{n+1}_{k-1}}{\Delta k_{k-1/2}}
  \right) \nonumber\\&
  ...
  + g \frac{1}{\Delta z_{k+1/2}+\Delta z_{k-1/2}}\left\{
    (1-\kappa_{k+1})\frac{(J_{33})_{k+1}P^n_{k+1}}{Q^n_{k+1}}
   -(1-\kappa_{k-1})\frac{(J_{33})_{k-1}P^n_{k-1}}{Q^n_{k-1}}
  \right\} \nonumber\\&
  + \frac{G^{\frac{1}{2}} S_{\rho\theta}}{\Delta t}
  - \frac{P^n}{\Delta t^2 Q^n}.
