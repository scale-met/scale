...
module scale_atmos_dyn_rk_fdm_heve
  !-----------------------------------------------------------------------------
  !
  !++ used modules
  !
  ...
  subroutine ATMOS_DYN_rk_heve( &
    ...
    IIE = IIS+IBLOCK-1
      ...
      call ATMOS_NUMERIC_FDM_EvalFlux(mflx_hi,                            &  ! (inout)
         & FLXEVALTYPE_CD4, VL_ZXY, VARTMP, MOMX, MOMY, MOMZ,             &  ! (in)
         & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_DENS,:),       &  ! (in)
         & IIS, IIE, JJS, JJE, KS, KE )                                      ! (in)
    
      !-----< update density >-----

      call ATMOS_NUMERIC_FDM_EvolveVar( DENS_RK,                             & ! (out)
         & DENS0, VL_ZXY, mflx_hi, GSQRT, MAPF, dtrk, RCDX, RCDY, RCDZ,      & ! (in)
      ...
      if ( FLAG_FCT_RHO ) then
         call ATMOS_NUMERIC_FDM_EvalFlux(qflx_lo,                              &  ! (inout)
              & FLXEVALTYPE_UD1, VL_ZXY, DENS, VELX, VELY, VELZ,               &  ! (in)
              & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_DENS,:),       &  ! (in)
              & IIS, IIE, JJS, JJE, KS, KE )                                      ! (in)
      endif
    ...
    if ( FLAG_FCT_RHO ) then
       ...
       IIE = IIS+IBLOCK-1
         ...
         call ATMOS_NUMERIC_FDM_EvolveVar( DENS_RK,                               & ! (out)
           & VARTMP, VL_ZXY, qflx_anti, GSQRT, MAPF, dtrk, RCDX, RCDY, RCDZ,      & ! (in)
           & IIS, IIE, JJS, JJE, KS, KE                                           & ! (in)
           & )
    ...
    IIE = IIS+IBLOCK-1
       ...
       call ATMOS_NUMERIC_FDM_EvalFlux(qflx_hi,                                  &  ! (inout)
         & FLXEVALTYPE_CD4, VL_WXY, MOMZ, VELX, VELY, VELZ,                      &  ! (in)
         & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_MOMZ,:),              &  ! (in)
         & IIS, IIE, JJS, JJE, KS, KE )                                             ! (in)
      ...
      call ATMOS_NUMERIC_FDM_EvolveVar( MOMZ_RK,                             & ! (out)
         & MOMZ0, VL_WXY, qflx_hi, GSQRT, MAPF, dtrk, RCDX, RCDY, RFDZ,      & ! (in)
       ...
       if ( FLAG_FCT_MOMENTUM ) then
         call ATMOS_NUMERIC_FDM_EvalFlux(qflx_lo,                              &  ! (inout)
           & FLXEVALTYPE_UD1, VL_WXY, MOMZ, VELX, VELY, VELZ,                  &  ! (in)
           & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_MOMY,:),          &  ! (in)
           & IIS, IIE, JJS, JJE, KS, KE )                                         ! (in)
       endif
#endif       
    enddo
    ...
    if ( FLAG_FCT_MOMENTUM ) then
       ...
       IIE = IIS+IBLOCK-1
         ...
         call ATMOS_NUMERIC_FDM_EvolveVar( MOMZ_RK,                               & ! (out)
           & VARTMP, VL_WXY, qflx_anti, GSQRT, MAPF, dtrk, RCDX, RCDY, RFDZ,      & ! (in)
    ...
    IIE = IIS+IBLOCK-1
      ...
      call ATMOS_NUMERIC_FDM_EvalFlux(qflx_hi,                                  &  ! (inout)
        & FLXEVALTYPE_CD4, VL_ZUY, MOMX, VELX, VELY, VELZ,                      &  ! (in)
        & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_MOMX,:),              &  ! (in)
        & IIS, IIE, JJS, JJE, KS, KE )                                             ! (in)
       ...
       call ATMOS_NUMERIC_FDM_EvolveVar( MOMX_RK,                            & ! (out)
         & MOMX0, VL_ZUY, qflx_hi, GSQRT, MAPF, dtrk, RFDX, RCDY, RCDZ,      & ! (in)
         & IIS, min(IIE,IEH), JJS, JJE, KS, KE-1, MOMX_t_nadv                & ! (in)
#ifdef HIST_TEND
         & ,lhist, advch_t, advcv_t                                          &
#endif       
         & )
       ...
       if ( FLAG_FCT_MOMENTUM ) then
          call ATMOS_NUMERIC_FDM_EvalFlux(qflx_lo,                              &  ! (inout)
           & FLXEVALTYPE_UD1, VL_ZUY, MOMX, VELX, VELY, VELZ,                   &  ! (in)
           & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_MOMX,:),           &  ! (in)
           & IIS, IIE, JJS, JJE, KS, KE )                                         ! (in)
      endif
#endif      
    ...
    if ( FLAG_FCT_MOMENTUM ) then
       ...
       IIE = IIS+IBLOCK-1
         ...
         call ATMOS_NUMERIC_FDM_EvolveVar( MOMX_RK,                               & ! (out)
           & VARTMP, VL_ZUY, qflx_anti, GSQRT, MAPF, dtrk, RFDX, RCDY, RCDZ,      & ! (in)
    ...
    IIE = IIS+IBLOCK-1
      ...
      call ATMOS_NUMERIC_FDM_EvalFlux(qflx_hi,                                  &  ! (inout)
        & FLXEVALTYPE_CD4, VL_ZXV, MOMY, VELX, VELY, VELZ,                      &  ! (in)
        & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_MOMY,:),              &  ! (in)
        & IIS, IIE, JJS, JJE, KS, KE )                                             ! (in)
       ...
       call ATMOS_NUMERIC_FDM_EvolveVar( MOMY_RK,                            & ! (out)
         & MOMY0, VL_ZXV, qflx_hi, GSQRT, MAPF, dtrk, RCDX, RFDY, RCDZ,      & ! (in)
         & IIS, IIE, JJS, min(JJE,JEH), KS, KE-1, MOMY_t_nadv                & ! (in)
#ifdef HIST_TEND
         & ,lhist, advch_t, advcv_t                                          &
#endif       
         & )
       ...
       if ( FLAG_FCT_MOMENTUM ) then
         call ATMOS_NUMERIC_FDM_EvalFlux(qflx_lo,                              &  ! (inout)
           & FLXEVALTYPE_UD1, VL_ZXV, MOMY, VELX, VELY, VELZ,                  &  ! (in)
           & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_MOMY,:),          &  ! (in)
           & IIS, IIE, JJS, JJE, KS, KE )                                         ! (in)
       endif
#endif
    ...
    if ( FLAG_FCT_MOMENTUM ) then
       ...
       IIE = IIS+IBLOCK-1
         ...
         call ATMOS_NUMERIC_FDM_EvolveVar( MOMY_RK,                               & ! (out)
           & VARTMP, VL_ZXV, qflx_anti, GSQRT, MAPF, dtrk, RCDX, RFDY, RCDZ,      & ! (in)
           & IIS, IIE, JJS, min(JJE,JEH), KS, KE                                  & ! (in)
           & )
    ...
    IIE = IIS+IBLOCK-1
      ...
      call ATMOS_NUMERIC_FDM_EvalFlux(tflx_hi,                                  &  ! (inout)
        ...
        & POTT, mflx_hi(:,:,:,XDIR), mflx_hi(:,:,:,YDIR), mflx_hi(:,:,:,ZDIR),  &  ! (in)
        & J13G, J23G, J33G, GSQRT, MAPF, num_diff(:,:,:,I_RHOT,:),              &  ! (in)
        & IIS, IIE, JJS, JJE, KS, KE )                                             ! (in)

      !-----< update rho*theta >-----

      call ATMOS_NUMERIC_FDM_EvolveVar( RHOT_RK,                             & ! (out)
         & RHOT0, VL_ZXY, mflx_hi, GSQRT, MAPF, dtrk, RCDX, RCDY, RCDZ,      & ! (in)
    ...
    if ( FLAG_FCT_T ) then
      ...
      call ATMOS_DYN_fct( tflx_anti,               & ! (out)
       ...
       IIE = IIS+IBLOCK-1
         ...
         call ATMOS_NUMERIC_FDM_EvolveVar( RHOT_RK,                               & ! (out)
           & VARTMP, VL_ZXY, tflx_anti, GSQRT, MAPF, dtrk, RCDX, RCDY, RCDZ,      & ! (in)
           & IIS, IIE, JJS, JJE, KS, KE                                           & ! (in)
           & )
...
end module scale_atmos_dyn_rk_fdm_heve
