...
#endif
          mflx_hi(k,i,j,ZDIR) = J33G * MOMZ_RK(k,i,j)
       enddo
       enddo
       enddo
#ifdef DEBUG
  ...
  subroutine solve_bicgstab( &
    ...
    IIE = IIS+IBLOCK-1
       ...
       do i = IIS, IIE
          ...
          call CHECK( __LINE__, v1(KS+1,i,j) )
#endif
          r(KS+1,i,j) = ( &
          ...
          call CHECK( __LINE__, v1(KE-1,i,j) )
#endif
          r(KE-1,i,j) = ( &
...
#endif
       if ( error/norm < epsilon .or. error > error2 ) then
#ifdef DEBUG
