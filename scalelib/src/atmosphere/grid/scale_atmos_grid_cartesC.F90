...
contains
  ...
  subroutine ATMOS_GRID_CARTESC_finalize
    ...
    !$acc exit data delete(ATMOS_GRID_CARTESC_CDZ, ATMOS_GRID_CARTESC_CDX, ATMOS_GRID_CARTESC_CDY, ATMOS_GRID_CARTESC_FDZ, ATMOS_GRID_CARTESC_FDX, ATMOS_GRID_CARTESC_FDY)
