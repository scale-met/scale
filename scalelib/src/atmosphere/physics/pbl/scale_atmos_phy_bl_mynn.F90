...
!OCL INDEPENDENT
    ...
    !$acc         smp,shpgh, &
    !$acc         dtldz,dqwdz,gammat,gammaq, &
    !$acc         flx,a,b,c,d,ap,rho_h,phi_n,tke,sf_t,CDZ,FDZ,z1, &
    !$acc         dummy, &
    !$acc         tsq,qsq,cov, &
    !$acc         prod_t,prod_q,prod_c,diss_p, &
    !$acc         fmin,kmin, &
