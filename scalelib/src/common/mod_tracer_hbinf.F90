...
!!
!! @par History
!! @li      2013-12-05 (S.Nishizawa)   [new] imported from inc_tracer_hbinf.f90
!!
!<
!-------------------------------------------------------------------------------
module mod_tracer_hbinf
  !-----------------------------------------------------------------------------
  !
  !++ used modules
  !
  ...
  integer, public, parameter :: nccn =  20
  integer, public, parameter :: nspc =   7
  integer, public, parameter :: QA   = 252
...
contains
  subroutine TRACER_hbinf_setup
    implicit none

    return
  end subroutine TRACER_hbinf_setup

end module mod_tracer_hbinf
