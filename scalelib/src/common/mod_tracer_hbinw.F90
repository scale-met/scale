...
!!
!! @par History
!! @li      2013-12-05 (S.Nishizawa)   [new] imported from inc_tracer_hbinw.f90
!!
!<
!-------------------------------------------------------------------------------
module mod_tracer_hbinw
  !-----------------------------------------------------------------------------
  !
  !++ used modules
  !
  ...
  integer, public, parameter :: QA = 54
...
contains
  subroutine TRACER_hbinw_setup
    implicit none

    return
  end subroutine TRACER_hbinw_setup

end module mod_tracer_hbinw
