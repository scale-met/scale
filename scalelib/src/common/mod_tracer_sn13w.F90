...
!!
!! @par History
!! @li      2013-12-05 (S.Nishizawa)   [new] imported from inc_tracer_sn13w.f90
!!
!<
!-------------------------------------------------------------------------------
module mod_tracer_sn13w
  !-----------------------------------------------------------------------------
  !
  !++ used modules
  !
  ...
  integer, public, parameter :: I_NC =  4
  integer, public, parameter :: I_NR =  5
...
contains
  subroutine TRACER_sn13w_setup
    implicit none

    return
  end subroutine TRACER_sn13w_setup

end module mod_tracer_sn13w
