...
extern int32_t file_read_data_par_c(       void         *var,    // (out)
				     const datainfo_t   *dinfo,  // (in)
...
extern int32_t file_get_globalattribute_text_c( const int32_t  fid,   // (in)
						const char    *key,   // (in)
						      char    *value, // (out)
						const int32_t  len);  // (in)

extern int32_t file_get_globalattribute_int_c( const int32_t  fid,   // (in)
					       const char    *key,   // (in)
					             int32_t *value, // (out)
					       const size_t   len);  // (in)

extern int32_t file_get_globalattribute_float_c( const int32_t  fid,   // (in)
						 const char    *key,   // (in)
						       float   *value, // (out)
						 const size_t   len);  // (in)

extern int32_t file_get_globalattribute_double_c( const int32_t  fid,   // (in)
						  const char    *key,   // (in)
						        double  *value, // (out)
						  const size_t   len);  // (in)

extern int32_t file_set_globalattribute_text_c( const int32_t  fid,    // (in)
						const char    *key,    // (in)
						const char    *value); // (in)

extern int32_t file_set_globalattribute_int_c( const int32_t  fid,   // (in)
					       const char    *key,   // (in)
					       const int32_t *value, // (in)
					       const size_t   len);  // (in)

extern int32_t file_set_globalattribute_float_c( const int32_t  fid,   // (in)
						 const char    *key,   // (in)
						 const float   *value, // (in)
						 const size_t   len);  // (in)

extern int32_t file_set_globalattribute_double_c( const int32_t  fid,   // (in)
						  const char    *key,   // (in)
