...
contains
  ...
  subroutine LAND_SFC_CONST( &
    ...
    real(RP) :: Tstar, Tstar10, Tstar2 ! friction potential temperature [K]
    real(RP) :: Qstar, Qstar10, Qstar2 ! friction water vapor mass ratio [kg/kg]
    ...
    do i = IS, IE
      ...
      if( LANDUSE_fact_land(i,j) > 0.0_RP ) then
        ...
        T2 (i,j) = ( 1.0_RP - Tstar / Tstar2 ) * LST(i,j) + Tstar / Tstar2 * TMPA(i,j)
