...
module mod_calendar
  ...
  !
  real(DP), private, save :: CALENDAR_DOI  = 365.0_DP !< days of year
  real(DP), private, save :: CALENDAR_HOUR = 24.0_DP  !< hours   of day
  real(DP), private, save :: CALENDAR_MIN  = 60.0_DP  !< minutes of hour
  real(DP), private, save :: CALENDAR_SEC  = 60.0_DP  !< seconds of minute

  integer,  private, parameter :: I_nonleapyear = 1   !< [index] non leap year
  integer,  private, parameter :: I_leapyear    = 2   !< [index] leap year
  integer,  private, save      :: dayofmonth(12,2)    !< days of each month
