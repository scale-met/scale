...
!  private :: MPRJ_Mercator_lonlat2xy
  ...
  real(RP), private, save :: MPRJ_hemisphere               ! hemisphere flag: 1=north, -1=south

  real(RP), private, save :: MPRJ_pole_x                   ! position of north/south pole in the model [m]
  real(RP), private, save :: MPRJ_pole_y                   ! position of north/south pole in the model [m]

  real(RP), private, save :: MPRJ_basepoint_lon = 135.2_RP ! position of base point in real world [deg]
  real(RP), private, save :: MPRJ_basepoint_lat =  34.7_RP ! position of base point in real world [deg]
  ...
  real(RP), private, save :: MPRJ_LC_lat2 = 60.0_RP        ! standard latitude2 for LC projection
  real(RP), private, save :: MPRJ_LC_c                     ! conformal factor
  real(RP), private, save :: MPRJ_LC_fact                  ! pre-calc factor

  real(RP), private, save :: MPRJ_PS_lon                   ! standard longitude for PS projection
  real(RP), private, save :: MPRJ_PS_lat  =  0.0_RP        ! standard latitude1 for PS projection
  real(RP), private, save :: MPRJ_PS_fact                  ! pre-calc factor
