  ...
  real(RP), private, parameter :: DX  =   1.0_RP ! length in the main region [m]: x
  real(RP), private, parameter :: DY  =   1.0_RP ! length in the main region [m]: y
  real(RP), private, parameter :: DZ  =   1.0_RP ! length in the main region [m]: z
