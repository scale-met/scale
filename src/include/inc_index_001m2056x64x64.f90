  ...
  real(8), private, parameter :: DX  =   1 ! length in the main region [m]: x
  real(8), private, parameter :: DY  =   1 ! length in the main region [m]: y
  real(8), private, parameter :: DZ  =   1 ! length in the main region [m]: z
