  ...
  real(RP), private, parameter :: DX  =   2 ! length in the main region [m]: x
  real(RP), private, parameter :: DY  =   2 ! length in the main region [m]: y
  real(RP), private, parameter :: DZ  =   2 ! length in the main region [m]: z
