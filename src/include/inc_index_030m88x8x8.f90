  ...
  real(RP), private, parameter :: DX  =  30.0_RP ! length in the main region [m]: x
  real(RP), private, parameter :: DY  =  30.0_RP ! length in the main region [m]: y
  real(RP), private, parameter :: DZ  =  30.0_RP ! length in the main region [m]: z
