  ...
  real(8), private, parameter :: DX  =  30 ! length in the main region [m]: x
  real(8), private, parameter :: DY  =  30 ! length in the main region [m]: y
  real(8), private, parameter :: DZ  =  30 ! length in the main region [m]: z
