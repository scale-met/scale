  ...
  integer, private, parameter :: IMAX =  21 ! # of computational cells: x
  integer, private, parameter :: JMAX =  21 ! # of computational cells: y

  integer, private, parameter :: KA   = 210 ! # of z whole cells (local, with HALO)
  integer, private, parameter :: IA   =  25 ! # of x whole cells (local, with HALO)
  integer, private, parameter :: JA   =  25 ! # of y whole cells (local, with HALO)
  ...
  integer, private, parameter :: IE   =  23 ! end   point of inner domain: x, local
  integer, private, parameter :: JS   =   3 ! start point of inner domain: y, local
  integer, private, parameter :: JE   =  23 ! end   point of inner domain: y, local

  integer, private, parameter :: IJA  =  441 ! # merged inner region(tentative usage)
  integer, private, parameter :: IJS  =    1 !
  integer, private, parameter :: IJE  =  441 !
