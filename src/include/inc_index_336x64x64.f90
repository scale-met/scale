  ...
  real(8), private, parameter :: DX  = 20 ! length in the main region [m]: x
  real(8), private, parameter :: DY  = 20 ! length in the main region [m]: y
  real(8), private, parameter :: DZ  = 20 ! length in the main region [m]: z
