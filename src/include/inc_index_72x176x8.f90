  ...
  !-----------------------------------------------------------------------------
  !
  !++ scale3 grid parameters (50m res., 3km isotropic, 4km model top)
  !
  !-----------------------------------------------------------------------------
  ...
  real(8), private, parameter :: BUFFER_DZ =  1.0D3 ! thickness of buffer region [m]: z
  ...
  integer, private, parameter :: KMAX =  72 ! # of computational cells: z
  integer, private, parameter :: IMAX = 176 ! # of computational cells: x
  integer, private, parameter :: JMAX =   8 ! # of computational cells: y

  integer, private, parameter :: KA   =  76 ! # of z whole cells (local, with HALO)
  integer, private, parameter :: IA   = 180 ! # of x whole cells (local, with HALO)
  ...
  integer, private, parameter :: KE   =  74 ! end   point of inner domain: z, local
  integer, private, parameter :: IS   =   3 ! start point of inner domain: x, local
  integer, private, parameter :: IE   = 178 ! end   point of inner domain: x, local
  ...
  integer, private, parameter :: IJA  = 1408 ! # merged inner region(tentative usage)
  integer, private, parameter :: IJS  =    1 !
  integer, private, parameter :: IJE  = 1408 !
