  ...
  integer, private, parameter :: QQA = 54 ! mass tracer (water)
  integer, private, parameter :: QQS = 1            ! start index for mass tracer
  integer, private, parameter :: QQE = 54  ! end   index for mass tracer
  ...
  data AQ_UNIT(2)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(3)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(4)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(5)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(6)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(7)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(8)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(9)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(10)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(11)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(12)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(13)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(14)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(15)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(16)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(17)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(18)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(19)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(20)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(21)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(22)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(23)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(24)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(25)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(26)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(27)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(28)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(29)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(30)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(31)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(32)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(33)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(34)  / 'kg/kg/unit log(r)' /
  data AQ_UNIT(35) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(36) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(37) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(38) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(39) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(40) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(41) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(42) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(43) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(44) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(45) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(46) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(47) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(48) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(49) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(50) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(51) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(52) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(53) / 'kg/kg/unit log(ra)' /
  data AQ_UNIT(54) / 'kg/kg/unit log(ra)' /
