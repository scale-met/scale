  ...
  integer, private, parameter :: IA    =  29 ! # of x whole cells (local, with HALO)
  integer, private, parameter :: JA    =  29 ! # of y whole cells (local, with HALO)
  ...
  integer, private, parameter :: IE    =  27 ! end   point of inner domain: x, local
  integer, private, parameter :: JS    =   3 ! start point of inner domain: y, local
  integer, private, parameter :: JE    =  27 ! end   point of inner domain: y, local

  integer, private, parameter :: IJA   =  625 ! # merged inner region(tentative usage)
  integer, private, parameter :: IJS   =    1 !
  integer, private, parameter :: IJE   =  625 !
