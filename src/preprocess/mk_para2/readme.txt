...
1, Modify the Makefile and create.sh
 Please modify the FC, FC1, FC2, and FFLAGS in Makefile and create.sh for your distribution

2, Setup the Number of hydrometeor's bin, and collection kernel
 Please open the setup.h by editor (vi or emacs), and modify the "nbin", "ncld", "ndrz", "ICEFLG", and "kphase". The meaning of these parameters area shonw below
 ...
 ICEFLG: flag for ice microphysics process (0 -> warm rain only, 1 -> include ice process)
 nspc   : Don't chenge!! (this is number of species of hydrometeor)
...
3, Run the shell named "create.sh".
 If the ascii file named micpara.dat and inc_tracer_***.f90 is created, you succeed to create "micpara.dat", and "inc_tracer***.f90"
