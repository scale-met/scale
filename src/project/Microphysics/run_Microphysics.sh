...
export OUTDIR=${HMDIR}/data/Microphysics
...
&PARAM_ATMOS_VARS
 ATMOS_QTRC_NMAX              = 11,
 ATMOS_RESTART_IN_BASENAME    = '${HMDIR}/data/init_warmbubble_lores/init_warmbubble_63072000000.000',
 ATMOS_RESTART_OUTPUT         = .true.,
 ATMOS_RESTART_OUT_BASENAME   = 'check_warmbubble',
 ATMOS_RESTART_CHECK          = .false.,
 ATMOS_RESTART_CHECK_BASENAME = '${HMDIR}/data/warmbubble_lores/check_warmbubble_63072000040.000',
/
...
&PARAM_HISTORY
 ...
 HISTORY_DEFAULT_TINTERVAL = 0.4D0,
...
&HISTITEM item='MOMZ' /
&HISTITEM item='RHOT' /
&HISTITEM item='MOMX_t_mp' /
&HISTITEM item='MOMY_t_mp' /
&HISTITEM item='MOMZ_t_mp' /
&HISTITEM item='RHOT_t_mp' /
&HISTITEM item='PRES' /
&HISTITEM item='U'    /
&HISTITEM item='V'    /
&HISTITEM item='W'    /
