...
!    enddo
    ...
    do j = JS-1, JE
    do i = IS-1, IE
       FLXt(KS-1,i,j,1:3) = 0.D0
       FLXt(KE  ,i,j,1:3) = 0.D0
    enddo
    enddo
    ...
    do j  = JS-1, JE
    do i  = IS-1, IE
       FLXij(KS-1,i,j,1,3) = FLXij_sfc(i,j,1)
       FLXij(KS-1,i,j,2,3) = FLXij_sfc(i,j,2)
       FLXij(KS-1,i,j,3,3) = FLXij_sfc(i,j,3)
       FLXt (KS-1,i,j,3)   = FLXt_sfc (i,j)
       FLXq (KS-1,i,j,3,1) = FLXqv_sfc(i,j)
    enddo
    enddo
