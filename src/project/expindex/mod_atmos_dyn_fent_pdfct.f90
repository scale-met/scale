...
call START_COLLECTION("RK3")
    ...
    do rko = 1, RK
       ...
       call COMM_vars8( var(:,:,:,I_DENS), I_DENS )
       call COMM_vars8( var(:,:,:,I_MOMZ), I_MOMZ )
       call COMM_vars8( var(:,:,:,I_MOMX), I_MOMX )
       call COMM_vars8( var(:,:,:,I_MOMY), I_MOMY )
       call COMM_vars8( var(:,:,:,I_RHOT), I_RHOT )
