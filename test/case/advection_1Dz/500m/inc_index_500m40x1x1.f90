  ...
  !-----------------------------------------------------------------------------
  !
  !++ scale3 grid parameters (500m res., 20km vertical 1D)
  !
  !-----------------------------------------------------------------------------
  integer,  private, parameter :: KMAX =   40 ! # of computational cells: z
  integer,  private, parameter :: IMAX =    1 ! # of computational cells: x
  integer,  private, parameter :: JMAX =    1 ! # of computational cells: y

  integer,  private, parameter :: IBLOCK =  1 ! block size for cache blocking: x
