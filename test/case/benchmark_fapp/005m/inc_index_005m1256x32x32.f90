  ...
  real(RP), private, parameter :: DZ =   5.0_RP ! length in the main region [m]: z
  real(RP), private, parameter :: DX =   5.0_RP ! length in the main region [m]: x
  real(RP), private, parameter :: DY =   5.0_RP ! length in the main region [m]: y

  real(RP), private, parameter :: BUFFER_DZ =10000.0_RP ! thickness of buffer region [m]: z
