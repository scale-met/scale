  !-----------------------------------------------------------------------------
  !
  !++ scale3 grid parameters (10m res)
  !
  !-----------------------------------------------------------------------------
  ...
  real(RP), private, parameter :: DX  = 10 ! length in the main region [m]: x
  real(RP), private, parameter :: DY  = 10 ! length in the main region [m]: y
  real(RP), private, parameter :: DZ  = 10 ! length in the main region [m]: z
  ...
  integer, private, parameter :: KMAX = 480 ! # of computational cells: z
  integer, private, parameter :: IMAX =   8 ! # of computational cells: x
  integer, private, parameter :: JMAX =   2 ! # of computational cells: y

  integer, private, parameter :: KA   = 484 ! # of z whole cells (local, with HALO)
  ...
  integer, private, parameter :: KE   = 482 ! end   point of inner domain: z, local
