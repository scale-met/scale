  !-----------------------------------------------------------------------------
  !
  !++ scale3 grid parameters (2.5m res)
  !
  !-----------------------------------------------------------------------------
  ...
  real(RP), private, parameter :: DX  = 2.5_RP ! length in the main region [m]: x
  real(RP), private, parameter :: DY  = 2.5_RP ! length in the main region [m]: y
  real(RP), private, parameter :: DZ  = 2.5_RP ! length in the main region [m]: z
  ...
  integer, private, parameter :: KMAX = 1920 ! # of computational cells: z
  integer, private, parameter :: IMAX =    8 ! # of computational cells: x
  integer, private, parameter :: JMAX =    2 ! # of computational cells: y

  integer, private, parameter :: KA   = 1924 ! # of z whole cells (local, with HALO)
  ...
  integer, private, parameter :: KE   = 1922 ! end   point of inner domain: z, local
