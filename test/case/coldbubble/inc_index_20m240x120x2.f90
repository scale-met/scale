  !-----------------------------------------------------------------------------
  !
  !++ scale3 grid parameters (20m res)
  !
  !-----------------------------------------------------------------------------
  ...
  real(RP), private, parameter :: DX  = 20 ! length in the main region [m]: x
  real(RP), private, parameter :: DY  = 20 ! length in the main region [m]: y
  real(RP), private, parameter :: DZ  = 20 ! length in the main region [m]: z
  ...
  integer, private, parameter :: KMAX = 240 ! # of computational cells: z
  integer, private, parameter :: IMAX = 120 ! # of computational cells: x
  integer, private, parameter :: JMAX =   2 ! # of computational cells: y

  integer, private, parameter :: KA   = 244 ! # of z whole cells (local, with HALO)
  integer, private, parameter :: IA   = 124 ! # of x whole cells (local, with HALO)
  ...
  integer, private, parameter :: KE   = 242 ! end   point of inner domain: z, local
  integer, private, parameter :: IS   =   3 ! start point of inner domain: x, local
  integer, private, parameter :: IE   = 122 ! end   point of inner domain: x, local
  ...
  integer, private, parameter :: IJA  = 240 ! # merged inner region(tentative usage)
  integer, private, parameter :: IJS  =   1 !
  integer, private, parameter :: IJE  = 240 !
