  ...
  integer, private, parameter :: KMAX = 192 ! # of computational cells: z
  integer, private, parameter :: IMAX =  96 ! # of computational cells: x
  integer, private, parameter :: JMAX =   2 ! # of computational cells: y

  integer, private, parameter :: KA   = 196 ! # of z whole cells (local, with HALO)
  integer, private, parameter :: IA   = 100 ! # of x whole cells (local, with HALO)
  ...
  integer, private, parameter :: KE   = 194 ! end   point of inner domain: z, local
  integer, private, parameter :: IS   =   3 ! start point of inner domain: x, local
  integer, private, parameter :: IE   =  98 ! end   point of inner domain: x, local
  ...
  integer, private, parameter :: IJA  = 192 ! # merged inner region(tentative usage)
  integer, private, parameter :: IJS  =   1 !
  integer, private, parameter :: IJE  = 192 !
