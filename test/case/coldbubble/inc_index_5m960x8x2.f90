  ...
  integer, private, parameter :: KMAX = 960 ! # of computational cells: z
  integer, private, parameter :: IMAX =   8 ! # of computational cells: x
  integer, private, parameter :: JMAX =   2 ! # of computational cells: y

  integer, private, parameter :: KA   = 964 ! # of z whole cells (local, with HALO)
  ...
  integer, private, parameter :: KE   = 962 ! end   point of inner domain: z, local
