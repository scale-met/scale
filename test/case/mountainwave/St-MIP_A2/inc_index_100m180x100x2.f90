  ...
  !-----------------------------------------------------------------------------
  !
  !++ scale3 grid parameters (St-MIP A2 case, 18km height, 3km buffer)
  !
  !-----------------------------------------------------------------------------
  integer,  private, parameter :: KMAX =  180 ! # of computational cells: z
  ...
  real(RP), private, save      :: DX        =  100.0_RP ! length in the main region [m]: x
  real(RP), private, save      :: DY        =  100.0_RP ! length in the main region [m]: y
